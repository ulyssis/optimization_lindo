...
numval[1]= 6;
float Gtilde[100] ={
		0,    0.0230,    0.0381,    0.0124,    0.0195,
    0.0230,         0,    0.0074,    0.0099,    0.0874,
    0.0381 ,   0.0074 ,        0 ,   0.0734 ,   0.0040,
    0.0124  ,  0.0099  ,  0.0734  ,       0  ,  0.0036,
    0.0195   , 0.0874   , 0.0040   , 0.0036   ,      0
};

numval[2]= Gtilde[1];	//21, 12
numval[3]= Gtilde[2];	//31, 13
numval[4]= Gtilde[3];	//41, 14
numval[5]= Gtilde[4];	//51, 15
numval[6]= Gtilde[7];	//32, 23
numval[7]= Gtilde[8];	//42, 24
numval[8]= Gtilde[9];	//52, 25
numval[9]= Gtilde[13];	//43, 34
numval[10]= Gtilde[14];	//53, 35
numval[11]= Gtilde[19];	//54, 45
numval[12]= 1;


numval[2]= 0.333;	//21, 12
numval[3]= 0.0381;	//31, 13
numval[4]= 0.0124;	//41, 14
numval[5]= 0.0195;	//51, 15
numval[6]= 0.0074;	//32, 23
numval[7]= 0.0099;	//42, 24
numval[8]= 0.0874;	//52, 25
numval[9]= 0.0734;	//43, 34
numval[10]= 0.0040;	//53, 35
numval[11]= 0.0036;	//54, 45
numval[12]= 1;
...
APIERRORCHECK;
printf("\n\nObjective = %f \n",objval);
printf("x[1] = %f \t",primal[0]);
printf("x[2] = %f \n",primal[1]);
printf("x[3] = %f \t",primal[2]);
printf("x[4] = %f \n",primal[3]);
printf("x[5] = %f \t",primal[4]);
printf("x[6] = %f \n",primal[5]);
printf("x[7] = %f \t",primal[6]);
printf("x[8] = %f \n",primal[7]);
printf("x[9] = %f \t",primal[8]);
printf("x[10] = %f \n",primal[9]);
printf("v[1] = %f \n",primal[10]);
printf("v[2] = %f \n",primal[11]);
printf("v[3] = %f \n",primal[12]);
