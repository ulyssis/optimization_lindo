/* This code is not involved with replacement of polynomial with a scalator variable*/
/*
...
*/
//pmax=(p1, p2);
/*	(p1*x3+p2*x4)*h21*(x1*x3+x2*x4) + (p1*x5+p2*x6)*h31*(x1*x5+x2*x6) + (p1*x7+p2*x8)*h41*(x1*x7+x2*x8) + (p1*x9+p2*x10)*h51*(x1*x9+x2*x10) +
...
//**          v3		**//
/*
* Instruction code of constraint 6:
* v3 - 6x5 >= 0;
*/
/* Constraint type */
ctype[icon]= 'G';
/* greater than or equal to */
/* Beginning position of constraint 6 */
cons_beg[icon]= ikod;
/* Instruction list code */
code[ikod++]= EP_PUSH_VAR;
code[ikod++]= 12;
...
code[ikod++]= EP_MULTIPLY;
code[ikod++]= EP_MINUS;
/* Length of constraint 6 */
cons_length[icon] = ikod - cons_beg[icon];
/* Increment the constraint count */
icon++;

/*
* Instruction code of constraint 7:
* v3 - 7x6 >= 0;
*/
/* Constraint type */
ctype[icon]= 'G';
/* greater than or equal to */
/* Beginning position of constraint 7 */
cons_beg[icon]= ikod;
/* Instruction list code */
code[ikod++]= EP_PUSH_VAR;
code[ikod++]= 12;
...
//**          v4		**//
/*
* Instruction code of constraint 9:
* v4 - 6x7 >= 0;
*/
/* Constraint type */
ctype[icon]= 'G';
/* greater than or equal to */
/* Beginning position of constraint 9 */
cons_beg[icon]= ikod;
/* Instruction list code */
code[ikod++]= EP_PUSH_VAR;
code[ikod++]= 13;
...
code[ikod++]= EP_MULTIPLY;
code[ikod++]= EP_MINUS;
/* Length of constraint 9 */
cons_length[icon] = ikod - cons_beg[icon];
/* Increment the constraint count */
icon++;

/*
* Instruction code of constraint 10:
* v4 - 7x8 >= 0;
*/
/* Constraint type */
ctype[icon]= 'G';
/* greater than or equal to */
/* Beginning position of constraint 10 */
cons_beg[icon]= ikod;
/* Instruction list code */
code[ikod++]= EP_PUSH_VAR;
code[ikod++]= 13;
...
//**          v5		**//
/*
* Instruction code of constraint 12:
* v5 - 6x9 >= 0;
*/
/* Constraint type */
ctype[icon]= 'G';
/* greater than or equal to */
/* Beginning position of constraint 12 */
cons_beg[icon]= ikod;
/* Instruction list code */
code[ikod++]= EP_PUSH_VAR;
code[ikod++]= 14;
...
code[ikod++]= EP_MULTIPLY;
code[ikod++]= EP_MINUS;
/* Length of constraint 12 */
cons_length[icon] = ikod - cons_beg[icon];
/* Increment the constraint count */
icon++;

/*
* Instruction code of constraint 13:
* v5 - 7x10 >= 0;
*/
/* Constraint type */
ctype[icon]= 'G';
/* greater than or equal to */
/* Beginning position of constraint 13 */
cons_beg[icon]= ikod;
/* Instruction list code */
code[ikod++]= EP_PUSH_VAR;
code[ikod++]= 14;
